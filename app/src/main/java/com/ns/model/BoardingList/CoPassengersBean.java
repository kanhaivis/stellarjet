...
public class CoPassengersBean implements Serializable {
    /**
     * booking_extra_id : 107
     * passenger : 22
     * name : Krishan Guest2
     * phone : 9874563202
     * membership :
     * seats_info : {"seat_id":11,"seat_code":"Juliet"}
     * pick_address : null
     * drop_address : null
     * boarding_pass_url :
     * boarding_pass_data : {"seat_name":"Juliet","seat_short_code":"J","traveller":"Krishan Guest2","aircraft":"STLR604","date":"02 05 2019","time":"0745","reportTime":"07.35am","departure":"Thursday 02 May 07.45am","from":"Bengaluru","to":"Delhi","from_code":"BLR","to_code":"DEL","stellar_club_code":22,"flight":"S5"}
     * status : Cancelled
    ...
    private SeatsInfoBeanX seats_info;
    private Object pick_address;
    private Object drop_address;
    private String boarding_pass_url;
    private BoardingPassDataBeanX boarding_pass_data;
    ...
    public CoPassengersBean.SeatsInfoBeanX getSeats_info() {
        return seats_info;
    }

    public void setSeats_info(CoPassengersBean.SeatsInfoBeanX seats_info) {
        this.seats_info = seats_info;
    }

    public Object getPick_address() {
        return pick_address;
    }

    public void setPick_address(Object pick_address) {
        this.pick_address = pick_address;
    }

    public Object getDrop_address() {
        return drop_address;
    }

    public void setDrop_address(Object drop_address) {
    ...
    public CoPassengersBean.BoardingPassDataBeanX getBoarding_pass_data() {
        return boarding_pass_data;
    }

    public void setBoarding_pass_data(CoPassengersBean.BoardingPassDataBeanX boarding_pass_data) {
    ...
    public static class SeatsInfoBeanX implements Serializable{
        /**
         * seat_id : 11
         * seat_code : Juliet
         */
    ...
    public static class BoardingPassDataBeanX implements Serializable{
        /**
         * seat_name : Juliet
         * seat_short_code : J
         * traveller : Krishan Guest2
         * aircraft : STLR604
         * date : 02 05 2019
         * time : 0745
         * reportTime : 07.35am
