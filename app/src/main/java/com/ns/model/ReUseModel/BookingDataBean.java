...
public class BookingDataBean implements Serializable {
    ...
    public List<BookingListBean> getBooking_details() {
        return booking_details;
    }

    public void setBooking_details(List<BookingListBean> booking_details) {
