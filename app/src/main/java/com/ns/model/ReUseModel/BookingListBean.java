...
public class BookingListBean implements Serializable {
     ...
     * journey_date : 2019-04-26
     * departure_datetime : 2019-04-26 08:00:00
     * journey_datetime : 1556245800000
     * booking_created_at : 2019-03-29 10:48:24
     * transaction_id : 97
     * booking_status : 12
     * status : Confirmed
     * booked_by : Krishan
     * booked_by_user_type : Primary
     * customer_seat : {"seat_id":11,"seat_code":"Juliet"}
     * seats : [{"seat_id":11,"seat_code":"Juliet"}]
     * guests : []
     * guest_seats : []
     * prefs : {"main_passenger":{"passenger":6,"name":"Krishan","phone":"8277027575","seats_info":{"seat_id":11,"seat_code":"Juliet"},"boarding_pass_url":"http://dev.stellarjet.com/app/v2/storage/uploads/boardingPasses/ST-6-Krishan-20190329104824.pdf","boarding_pass":{"seat_name":"Juliet","seat_short_code":"J","traveller":"Krishan","aircraft":"STLR604","date":"26 04 2019","time":"0800","reportTime":"07.50am","departure":"Friday 26 April 08.00am","from":"Bengaluru","to":"Mumbai","from_code":"BLR","to_code":"BOM","stellar_club_code":6,"flight":"S3"},"status":"Confirmed","last_modified_by":"Krishan","modified_user_type":"Primary","food_items":[],"user_meta_data":[{"meta_key":"food_prefs","meta_value":[{"food_category":"veg","days":["Monday","Tuesday"]},{"food_category":"non-veg","days":["Monday","Tuesday","Friday","Saturday"]},{"food_category":"continental","days":["Monday","Tuesday"]}]},{"meta_key":"food_spl_instruction","meta_value":"undefined"},{"meta_key":"billing_address","meta_value":"Ninestars"},{"meta_key":"discount_offered_membership","meta_value":"10.00"},{"meta_key":"discount_offered_seat","meta_value":"10.00"}]},"co_passengers":[]}
     * assigned_drivers : []
     */
    ...
    private int pick_address_main_id;
    private String drop_address_main;
    private int drop_address_main_id;

    public int getPick_address_main_id() {
        return pick_address_main_id;
    }

    public void setPick_address_main_id(int pick_address_main_id) {
        this.pick_address_main_id = pick_address_main_id;
    }

    public int getDrop_address_main_id() {
        return drop_address_main_id;
    }

    public void setDrop_address_main_id(int drop_address_main_id) {
        this.drop_address_main_id = drop_address_main_id;
    }
    ...
    private List<?> guests;
    private List<GuestsBean> guest_seats;
    ...
    public List<GuestsBean> getGuest_seats() {
        return guest_seats;
    }

    public void setGuest_seats(List<GuestsBean> guest_seats) {
