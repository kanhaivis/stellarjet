...
public class SeatTenFragment extends Fragment implements View.OnClickListener, PassengerListFragment.BackButtonIcon {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.seat_ten_layout, container, false);
    }
