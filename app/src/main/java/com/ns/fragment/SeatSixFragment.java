...
public class SeatSixFragment extends Fragment implements View.OnClickListener, PassengerListFragment.BackButtonIcon {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.seat_six_layout, container, false);
    }
